...
import Mullvad from './views/Mullvad';
...
const mullvadRoute = createRoute({ getParentRoute: () => rootRoute, path: '/mullvad', component: Mullvad });
const settingsRoute = createRoute({ getParentRoute: () => rootRoute, path: '/settings', component: Settings });

const routeTree = rootRoute.addChildren([inboxRoute, sendRoute, historyRoute, dropsRoute, syncRoute, mullvadRoute, settingsRoute]);
